  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-12 relative z-40 flex justify-end items-center min-h-screen">
        <div className="max-w-full lg:max-w-[50%] mt-20">
          <motion.div 
          ...
          >
            <div className="space-y-6">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-rose-pink/10 text-rose-pink text-[10px] font-bold uppercase tracking-[0.3em] border border-rose-pink/20 backdrop-blur-md"
              >
              ...
              <h1 className="font-headline text-5xl md:text-7xl lg:text-8xl text-foreground leading-[0.95] tracking-tight">
                Stories That <br />
                <span className="italic text-rose-pink">Bloom</span> Into Worlds
              </h1>
              
              <p className="max-w-xl text-xl text-muted-foreground leading-relaxed font-headline italic">
